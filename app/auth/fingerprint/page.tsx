        ...
        <div className="w-full md:w-1/2 p-4 flex flex-col justify-center space-y-4">
          <div className="w-3/4 max-w-sm mx-auto">
            ...
            <div className="text-center mt-2 mb-3 space-y-3">
              <div className="text-black text-lg font-semibold mb-2">Sign In with Fingerprint</div>
              <p className="text-xs text-gray-600 mb-2">Use your registered fingerprint credential to login.</p>
