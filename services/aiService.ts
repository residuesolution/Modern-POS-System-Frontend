...
export const getRecommendations = async (payload: RecommendRequest): Promise<RecommendResponse> => {
  try {
...
export const getPromos = async (payload: PromoRequest): Promise<PromoResponse> => {
  try {
...
export const getFraudScore = async (payload: FraudRequest): Promise<FraudResponse> => {
  try {
...
export const getReorderSuggestion = async (payload: ReorderRequest): Promise<ReorderResponse> => {
  try {
    const response = await axios.post<ReorderResponse>(
